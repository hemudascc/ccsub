...
<body>
	...
	<p>
	<h3 style="color: red;">
	<a href="http://192.241.253.234/ccsub/cnt/rcerpaotrt/hourlyreport">International |
	</a>
	</h3>
	...
	href="http://<%=request.getLocalAddr()%>/ccsub/cnt/rcerpaotrt/currentstats">Adnetwork Report</a> |
	
	<a 
	href="http://<%=request.getLocalAddr()%>/ccsub/cnt/rcerpaotrt/aggstats">Monthly Report</a></h3>
  ...
  <table>
	...
	<a 
	href="http://<%=request.getLocalAddr()%>
	/ccsub/cnt/rcerpaotrt/hourlyreport?opid=${operator.operatorId}">${operator.operatorName} ||</a>	
	</c:forEach>
	</h3>
	</p>
	...
	href="http://<%=request.getLocalAddr()%>/ccsub/cnt/rcerpaotrt/hourlyreport?opid=${param.opid}&productid=${product.id}">${product.productName} |</a></h3></td>	
	</c:forEach>
	</tr>
	</table>
	
   <form:form modelAttribute="AggReport" id="reportform" name="reportform"
    action="${pageContext.request.contextPath}/cnt/rcerpaotrt/hourlyreport">
