...
$(document).ready(function() {
	...
	function openModal(){
		var enteredMsisdn = document.getElementById("msisdn").value;
		var selectedOperator = document.getElementById("telcoid").value;
		if(enteredMsisdn != undefined && enteredMsisdn != null && enteredMsisdn != ""){
			if(selectedOperator != undefined && selectedOperator != null && selectedOperator != "" && selectedOperator !="Select Operator"){
			console.log("enteredMsisdn:  "+enteredMsisdn+", selectedOperator:  "+selectedOperator );
			 $('#confirm-modal').modal('show');
				$("#message").hide();
			}else{
				console.log("Please select operator :");
				 $("#message").text($("#operator-msg").val());
				 $('#confirm-modal').modal('hide');
			}
		}else{
			console.log("Please enter mobile No: "+enteredMsisdn);
			 $("#message").text($("#msisdn-msg").val()); 
			$('#confirm-modal').modal('hide');
		}
...
<body>
  ...
  <!-- <form id="frm">  -->
        ...
        <input id="msisdn-msg" value="Please Enter Mobile Number" type="hidden">
        <input id="operator-msg" value="Please Select Operator" type="hidden">
        ...
        <!-- <div><input type="checkbox" id="tc-confirm"> I've read and accept the <span style="color:red">Terms & Condition</span></div> -->
     		<p id="message"></p>
        <button id = "btn"  type = "button" class="btn btn-custom btn-primary" onclick="openModal();">Confirm</button>
   ...
   <!-- </form> --> 
    ...
    <div class="dsc-container">
        ...
        <span>The expiry date will be 31/12/2021, the max charge is HK$ 3210. The first week: HK$ 90 includes a signup fee. Starting from 2nd week to 52nd week, HK$ 60 per week.</span>
