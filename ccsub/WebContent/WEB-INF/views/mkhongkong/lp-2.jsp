...
<body>
    <div class="container img-container">
        <img class="center-block img-rounded" style="width: 100%;margin-bottom: 10px;" src="${pageContext.request.contextPath}/resources/mkhongkong/image/lp2-banner.png"/>
    </div>
    <div class="jumbotron">
      <h4>
	SMS <span class='bl-txt'>GG</span>
    	to <span class='bl-txt'>503230</span>
      <br>
      to get your content!
      </h4>
    </div>
