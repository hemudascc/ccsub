...
<!--                                 <a href="#" onclick="document.getElementById('form-id').submit();">SUSCRIBETE</a> -->
                                	...
                                	<a href="sms:/${veooServiceConfig.shortCode}/;body=${veooServiceConfig.keyword}">
                                	<img height="100px" width="300px" src="${pageContext.request.contextPath}/resources/images/veoo/rica_cost_enviar.png">
                                	</a>
                                	<p> <h1><b>JUEGOS al 1244</b></h1></p>
                                </div>
