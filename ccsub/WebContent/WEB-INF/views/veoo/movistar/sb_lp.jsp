	...
	<div id="main">
        ...
        <div class="buttonbar">
                 ...
                 <form id="form-id" action="${pageContext.request.contextPath}/cnt/veoo/lpform" method="post">
                                 ...
                                 <br>
                                <div class="button"><a href="#" onclick="document.getElementById('form-id').submit();">SUSCRIBETE</a></div>
            ...
            <p class="terms">
            Al hacer click quedaras suscrito a Tabu SirenBox donde encontraras Bellezas Mundiales. Recibiras un mensaje diario. CstxDia $0.23 Imp Incluidos. Para cancelar envía BAJA al 2510. Atencion al cliente: www.interacel.com 
</p>
        </div>
    </div>
</body>
