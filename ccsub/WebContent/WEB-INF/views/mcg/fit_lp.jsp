...
<body>
	...
	<section class="page_wrap__content">
		...
		<form class="page_wrap__content__form" action="${pageContext.request.contextPath}/cnt/mcg/lp" 
		method="POST">
...
<!--         class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b" >Abonniere jetzt</a> -->
		...
		<div class="page_wrap__content__text">
			...
			Sie die <a href="${pageContext.request.contextPath}/cnt/mcg/fitness/termcondtion?serviceid=${mcgServiceConfig.serviceId}"><strong>Terms &amp; Bedingungen</strong></a> <br> Hilfe? Bitte rufen Sie 0080 022 3018 an
