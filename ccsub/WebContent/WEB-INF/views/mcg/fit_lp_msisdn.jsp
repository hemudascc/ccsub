...
<body>
	...
	<section class="page_wrap__content">
		...
		<form class="page_wrap__content__form" action="http://mob.ccd2c.com/CH/TheBestMe/home" method="POST">
			...
			<input maxlength="10" name="msisdn" class="page_wrap__content__form__phone"
			 placeholder="Enter number" value="08" type="text"> 
			<input class="page_wrap__content__form__submit" value="Abonniere jetzt" type="submit">
...
<!--         class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b" >Abonniere jetzt</a> -->
		...
		<div class="page_wrap__content__text">
			Fitness für Sie ab 16 Jahren Senden Sie xxxx jederzeit an xxxxx, um
			...
			"xxxxxx" und genießen Sie unsere Lifestyle-Videos! Gebühren werden
			...
			Sie die <a href="http://ie.fitnessforyou.club/tc"><strong>Terms
					&amp; Conditions</strong></a> <br> Hilfe? Bitte rufen Sie xxxxxxxxxx an
