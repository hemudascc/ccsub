...
<body
	...
	<div class="ng-scope" ng-app="app">
		...
		<div align="center">
			    ...
			    <input type="image" src="${pageContext.request.contextPath}/resources/mcg/gamesarena/btn_img.png" 
			    alt="Submit" width="50%" >				
		...
		<div class="addBody text-center textP text-white ng-scope">
			...
			<p class="textP" style="color: #000;">
				...
				SMS. Antworten Sie START ABO GAMESARENA 321, um unbegrenzte Spiele von Games-Arena zu
				genieen." <br /> <br /> Der Games-Arena ist ein Abonnement-Service,
