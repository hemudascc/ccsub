...
<body
	...
	<div class="ng-scope" ng-app="app">
		...
		<p class="page_wrap__content__form__text"><strong>Zum Abonnieren dieser Nachricht
		 Go Game senden Sie die Option START ABO GAMESPARK an die 311 -Meldung an</strong>
      </p>
		...
		<div class="addBody text-center textP text-white ng-scope">			
			<p class="textP" style="color: #000;">
				"Antworten Sie START ABO GAMESPARK 311, um unbegrenzte Spiele von Games Park zu
				genieen." <br />  Der Games-Park ist ein Abonnement-Service,
				...
				<a
				 href="${pageContext.request.contextPath}/cnt/mcg/termcondtion?serviceid=${mcgServiceConfig.serviceId}"><strong>Terms &amp; Bedingungen</strong></a>
