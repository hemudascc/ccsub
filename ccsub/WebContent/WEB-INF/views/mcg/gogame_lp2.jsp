...
<body
	...
	<div class="ng-scope" ng-app="app">
		...
		<p class="page_wrap__content__form__text"><strong>Zum Abonnieren dieser Nachricht
		 Go Game senden Sie die Option START ABO GOGAMES an die 321 -Meldung an</strong>
      </p>
		...
		<div class="addBody text-center textP text-white ng-scope">
			...
			<p class="textP" style="color: #000;">
				"Antworten Sie START ABO GOGAMES 321, um unbegrenzte Spiele von Go-Games zu
				genieen." <br />  Der Go-Games ist ein Abonnement-Service,
