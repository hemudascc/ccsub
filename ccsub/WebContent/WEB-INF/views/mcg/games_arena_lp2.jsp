...
<link rel="shortcut icon" href="${pageContext.request.contextPath}/resources/mcg/gamesarena/gamesarena_favicon.png"> 
...
<body
	style="background-color: #DF7380; background-size: cover; font-family: 'Montserrat', sans-serif;">
	...
	<div class="ng-scope" ng-app="app">
		...
		<div class="product_name">
			<img src="${pageContext.request.contextPath}/resources/mcg/gamesarena/product.png"
			 class="img-responsive">
		</div>
		<div class="text-center ng-scope"
			ng-init="whoIAm = 'ch-bc-perso1'; countryId = 41">
			<img src="${pageContext.request.contextPath}/resources/mcg/gamesarena/games_arena_logo.jpg"
		...
		<div class="text-center">
	   	<p class="page_wrap__content__form__text"><strong>Dies ist ein abonnementbasiertes Online-Gaming-Portal für mobile Benutzer, das preiodisch mit neuen Spielen aktualisiert wird und der Benutzer kann unbegrenzt online Spiele bezahlen</strong>
</p>
  
		<p class="page_wrap__content__form__text"><strong>Zum Abonnieren dieser Nachricht
		 Go Game senden Sie die Option START ABO GAMESARENA an die 321 -Meldung an</strong>
      </p>
		...
		<p class="page_wrap__content__form__text">
		 ...
		 Sie knnen
				jederzeit von Ihrer Kontoseite abbrechen oder einen <b>STOP an die
				 321 </b>senden. Wenn Sie Hilfe bentigen, kontaktieren Sie uns bitte,
		...
		<div class="addBody text-center textP text-white ng-scope">
			...
			<p class="textP" style="color: #000;">
				"Antworten Sie START ABO GAMESARENA 321, um unbegrenzte Spiele von Games Arena zu
				genieen." <br />  Der Games-Arena ist ein Abonnement-Service,
