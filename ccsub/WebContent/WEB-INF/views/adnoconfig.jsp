	...
	<c:forEach var="vwadnetworkOperatorConfig" items="${list}" varStatus="outerloop">
			...
			<tr bgcolor="" align="center">
					...
					<td>${vwadnetworkOperatorConfig.adNetworkName}</td>		
					 <td>
				   <select name="zeroPriceActivationSend" >	
				   	  	
				   	   <c:if test="${vwadnetworkOperatorConfig.zeroPriceActivationSend==true}">	     
					  <option value="true" selected>True</option>
					    <option value="false" >False</option>
					  </c:if>
					  <c:if test="${vwadnetworkOperatorConfig.zeroPriceActivationSend==false}">	     
