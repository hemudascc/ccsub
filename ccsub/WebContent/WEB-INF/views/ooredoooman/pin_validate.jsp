...
<!--<div style="text-align:center;padding-top:5px;font-weight:bold;font-size:8px;">
			...
			src="${pageContext.request.contextPath}/resources/oordeoooman/banner1.png" class="img-responsive" height="200" width="300"></img></p>
				<p style="text-align:center;font-size:14px;" id="eng2">Get Unlimited Access To Games</p>

		<p style="text-align:center;font-size:10px;" id="eng2">
		  You have opted to Subscribe Gamezine App you will be auto renewal with OMR 1.25 / week.</p>
			
			<p style="text-align:center;font-size:12px;" id="eng2">
			 Please enter the Pin you received in your mobile</p>
			<div class="ok" style="max-width: 100%;padding-bottom: 15px;">
			<form method="get" action="${pageContext.request.contextPath}/cnt/ooman/web/send/otp/validation">
			    <input id="msisdn" type="hidden" name="msisdn" value="${msisdn}">
			   <input id="token" type="hidden" name="token" value="${token}">
			<input type="text" name="pin" id="pin"  style="width:90%">
			<button type="submit" name="submit" class="button" style="font-size: 15px;">
			<span id="eng3">CLICK HERE TO CONFIRM</span>
			</button>
