...
<body>
	...
	<p style="text-align:center;font-size:14px;" id="eng2">
	       <strong>Gamezine App</strong> <br/> Mobile Number</p>
			<div class="ok" style="max-width: 100%;padding-bottom: 15px;text-align:center;">
			<form method="get" action="${pageContext.request.contextPath}/cnt/ooman/web/send/otp">
                <input id="token" type="hidden" name="token" value="${token}"/>
			<input type="hidden" name="lang" id="lang" value="1">
			<center>${msisdn}</center>
			<input type="hidden" name="msisdn" id="msisdn" value="${msisdn}" required/><br/><br/>
			<button type="submit" name="submit" class="button" style="font-size: 15px;align:center">
