			...
			class="img-responsive"
			 height="200" width="300"></img></p>
			    <div class="imgtextcentered" dir="rtl"><h2>240 د.ع للرسالة المستلمة يوميا</h2></div>
				   ...
				   <p style="text-align:center;font-size:14px;"><strong></strong>
				    You are using non zain iraq internet connection. please use zain iraq mobile data
     and   <a href="http://192.241.253.234/ccsub/cnt/cmp?adid=1&cmpid=194&token=zain1">Click Here</a> 
     or send sms KK to 3368 to subscribe Kido Kingdom service
     </p>
			 <p>
