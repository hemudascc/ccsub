...
<body>
			...
			<p style="text-align:center;font-size:14px;"><strong>${actelServiceConfig.packageName}</strong><br/></p>
			<p style="text-align:center;font-size:14px;font-weight:bold;">
			<strong>You have been successfully subscribed </strong> <br/><strong>to ${actelServiceConfig.packageName} service.</strong></p>
				...
				<div style="text-align:center;font-size:14px;">
				Click <a href="${portalurl}">here</a>	to access the ${actelServiceConfig.packageName}
				</div>
				<div style="text-align:center;font-size:14px;">
