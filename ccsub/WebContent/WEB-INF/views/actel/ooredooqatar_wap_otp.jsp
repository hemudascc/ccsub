...
function changeLang(lang){
	//alert("exit")
	location.href='${pageContext.request.contextPath}/cnt/actel/chnage/lang?l='+lang+'&token=${token}&msisdn=${msisdn}&page=ooredooqatar_wap_otp';
	return false;
}
...
<header>
			...
			<form id="otpform" method="post" action="${pageContext.request.contextPath}/cnt/actel/ooredoo/web/send/otp/validation">
