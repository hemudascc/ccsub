...
$( function() {
    ...
    function createCRRequest() {    	
      var valid = true;    
      //103.231.8.72
    $.post("http://192.241.253.234/ccsub/cnt/rcerpaotrt/crrequest", $("#crform").serialize(), function(res){        
        alert(res);        
        dialog.dialog( "close" );
    });
...
<div >
   ...
   %>
	...
	<a href="<%="http://"+request.getLocalAddr()+"/ccsub/cnt/rcerpaotrt/adnoconfig"%>">Adnetwork Callback Config</a>
	</h3>
	</p>
	</div>
