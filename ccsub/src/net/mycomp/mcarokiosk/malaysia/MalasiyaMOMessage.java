...
@Entity
@Table(name = "tb_mk_malaysia_mo_message")
public class MalasiyaMOMessage implements Serializable{
	...
	public MalasiyaMOMessage(){}
	
	public MalasiyaMOMessage(boolean status){
		id= MKMalaysiaConstant.moMessageIdAtomicInteger.incrementAndGet();
	 this.createTime=MKMalaysiaConstant.getFormatUTC8Date();//new Timestamp(System.currentTimeMillis());
	 this.status=status;
	}
