...
@Entity
@Table(name = "tb_mk_malaysia_mt_message")
public class MalasiyaMTMessage implements Serializable{
...
//	private String action;
	...
	public MalasiyaMTMessage(){
		
	}
	
	public MalasiyaMTMessage(boolean status){
	 id= MKMalaysiaConstant.mtMessageIdAtomicInteger.incrementAndGet();
