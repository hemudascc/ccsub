...
@Entity
@Table(name = "tb_mk_malaysia_delivery_notification")
public class MalaysiaDeliveryNotification implements Serializable{
	...
	public MalaysiaDeliveryNotification(){}
	public MalaysiaDeliveryNotification(boolean status){
		this.retry=false;
