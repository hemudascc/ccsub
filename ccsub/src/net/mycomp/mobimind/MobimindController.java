...
public class MobimindController {
	...
	private static final Logger logger = Logger
			.getLogger(MobimindController.class.getName());
	...
	public ModelAndView cgCallback(HttpServletRequest request,ModelAndView modelAndView){
			...
			try{
				//http://mob.ccd2c.com/ccsub/cnt/mobimind/cgcallback?CGMSISDN=97336030000&CGStatus=0
				...
				mobimindCGCallback.setToken(request.getParameter("trxid"));
			   ...
			   if(mobimindCGCallback.getCgStatus()!=null&&
				   ...
				   LiveReport liveReport=new LiveReport(vwServiceCampaignDetail.getOpId(),
						...
						//modelAndView.setViewName("mobimind/success");
	...
	//http://192.241.253.234/ccsub/cnt/mobimind/notification?
	//User=CollectCent&Password=C01IectCent&ServiceId=665
	//&Status=ACT-SB&OperatorID=42604&MSISDN=97336030000&RequestId=532766521&ChannelId=4716
...
//			mobimindNotification.setServiceId(request.getParameter("ServiceId"));
//			mobimindNotification.setNotificationStatus(request.getParameter("Status"));
//			mobimindNotification.setOperatorId(request.getParameter("OperatorID"));
//			mobimindNotification.setMsisdn(request.getParameter("MSISDN"));
//			mobimindNotification.setRequestId(request.getParameter("RequestId"));
//			mobimindNotification.setChannelId(request.getParameter("ChannelId"));
...
//	}	
	...
	public String notification(ModelAndView modelAndView,HttpServletRequest request){
		...
		try{
			...
			mobimindNotification.setTrxId(request.getParameter("trxid"));
			mobimindNotification.setPrice(request.getParameter("Price"));
			mobimindNotification.setQueryStr(request.getQueryString());
