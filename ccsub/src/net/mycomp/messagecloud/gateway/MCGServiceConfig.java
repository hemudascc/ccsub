...
public class MCGServiceConfig {
	...
	@Column(name="mt_content_push_url")
	private String mtContentPushUrl;
	@Column(name="mt_billing_push_url")
	private String mtBillingPushUrl;
...
public String getMtContentPushUrl() {
	return mtContentPushUrl;
}


public void setMtContentPushUrl(String mtContentPushUrl) {
	this.mtContentPushUrl = mtContentPushUrl;
}


public String getMtBillingPushUrl() {
	return mtBillingPushUrl;
}


public void setMtBillingPushUrl(String mtBillingPushUrl) {
