...
public class MCGApiService {
	...
	public  MCGMTMessage sendContentMessage(String msisdn,MCGServiceConfig mcgServiceConfig,
			...
			,String msg,String token,String action,String moId){
	...
	String url=	mcgServiceConfig.getMtContentPushUrl()
		...
		.replaceAll("<shortcode>",MUtility.urlEncoding( mcgServiceConfig.getShortCode()))
		.replaceAll("<cc>", MUtility.urlEncoding(mcgMTMessage.getCc()))
		.replaceAll("<ekey>", MUtility.urlEncoding(mcgMTMessage.getEkey()));
		if(moId==null){
			url=url.replaceAll("<swisscomid>", "");
		}else{
		url=url.replaceAll("<swisscomid>", MUtility.urlEncoding(moId+"|"+mcgMTMessage.getId()));
		}
		;
	...
	String url=	mcgServiceConfig.getMtBillingPushUrl()
		.replaceAll("<number>",MUtility.urlEncoding(mcgMTMessage.getNumber()))
		.replaceAll("<message>",MUtility.urlEncoding( mcgMTMessage.getMessage()))
		.replaceAll("<title>",MUtility.urlEncoding( mcgMTMessage.getTitle()))
		.replaceAll("<shortcode>",MUtility.urlEncoding( mcgServiceConfig.getShortCode()))
		...
		.replaceAll("<reply>", MUtility.urlEncoding(mcgMTMessage.getReply()))
		.replaceAll("<swisscomid>", MUtility.urlEncoding(mcgServiceConfig.getConfigServiceName()+"|"+mcgMTMessage.getId()))
		;
