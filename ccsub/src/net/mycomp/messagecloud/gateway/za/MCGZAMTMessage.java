...
public class MCGZAMTMessage implements Serializable{
	...
	public MCGZAMTMessage(){}
	public MCGZAMTMessage(boolean status){
		
		//id=MCGZAConstant.inMCGMTMessageIdAtomicInteger.incrementAndGet();
		this.status=status;
