...
//		}
	...
	public static boolean valid(String msisdn){
		try{
	     ...
	     msisdn= msisdn.startsWith("41")?msisdn:"41"+msisdn;
			if(msisdn.length()==11){//41765005727 //41787472088
				return true;
			}
		}catch(Exception ex){
	...
	public static void main(String arg[]){
		System.out.println(formatMsisdn("+0787472088"));
		MCGServiceConfig mcgServiceConfig=mapIdToMCGServiceConfig.get(2);
		String action=MCGConstant.findAction("start abo",mcgServiceConfig);
		System.out.println(formatMsisdn("action:: "+action));
		
		System.out.println("valid msisdn "+valid(formatMsisdn("41787472088")));
	}
