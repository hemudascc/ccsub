...
@Entity
@Table(name = "tb_mt2_uae_notification_sdp")
public class Mt2UAENotificationSdp implements Serializable {

	//Id=20122212303719741&Data=S,392,87dba3d7-fba1-40f2-9f6b-b9dacb374754&TrackingId=aaa2086a11f048adb81cabd162e2f4d2&MSISDN=971523051932
	//&ShortCode=9132&Date=20202212&Operator=Du&ValidityDays=0
	private static final long serialVersionUID = 1L;
	public Mt2UAENotificationSdp() {
	}
	public Mt2UAENotificationSdp(Boolean status) {
		this.status = status;
	...
	public String toString() {
		return "Mt2UAENotification [id=" + id + ", sdpId=" + sdpId + ", data=" + data + ", trackingId=" + trackingId
