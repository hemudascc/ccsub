...
@Entity
@Table(name="tb_mt2_ksa_delivery_notification_sdp")
public class Mt2KSADeliveryNotificationSdp implements Serializable {
	...
	public Mt2KSADeliveryNotificationSdp(){}
	public Mt2KSADeliveryNotificationSdp(Boolean status) {
		this.status = status;
	...
	public String toString() {
		return "Mt2KSADeliveryNotificationSdp [id=" + id + ", sdpId=" + sdpId + ", data=" + data + ", msisdn=" + msisdn
