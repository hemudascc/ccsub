...
//		}
	...
	public ModelAndView updateadnopconfig(HttpServletRequest request,@RequestParam(value="adnopconfigid")
	 ...
	 @RequestParam(value="zeroPriceActivationSend",defaultValue="false")Boolean zeroPriceActivationSend){
		...
		adnetworkOperatorConfig.setZeroPriceActivationSend(zeroPriceActivationSend);
		daoService.updateObject(adnetworkOperatorConfig);
		logger.info("updateadnopconfig:: query string "+request.getQueryString());		
		ModelAndView modelAndView=new ModelAndView("redirect:/cnt/rcerpaotrt/adnoconfig");
		return modelAndView;
	}
