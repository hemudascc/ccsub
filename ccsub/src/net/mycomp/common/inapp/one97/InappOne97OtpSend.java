...
@Entity
@Table(name = "tb_one97_inapp_otp_send")
public class InappOne97OtpSend implements Serializable{
    ...
    public InappOne97OtpSend(){}
	
	public InappOne97OtpSend(boolean status){
		this.status=status;
		this.sendOtp=false;
