...
@Entity
@Table(name = "tb_inapp_tmt_otp_validation")
public class InappTmtOtpValidation implements Serializable{
...
public InappTmtOtpValidation(){}
	
	public InappTmtOtpValidation(boolean status){
		this.status=status;
		this.pinValidate=false;
		this.createTime=new Timestamp(System.currentTimeMillis());
		//this.id=InappTmtConstant.otpValidationIdAtomicInteger.incrementAndGet();
	}
