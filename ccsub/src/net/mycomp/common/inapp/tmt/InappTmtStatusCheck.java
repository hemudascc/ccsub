...
@Entity
@Table(name = "tb_inapp_tmt_status_check")
public class InappTmtStatusCheck implements Serializable{
	...
	public InappTmtStatusCheck(){}
	
	public InappTmtStatusCheck(boolean status){
		this.status=status;
