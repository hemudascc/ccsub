...
public interface MConstants {
	...
	public static DateTimeFormatter sdfDDMMyyyyHH = DateTimeFormatter.ofPattern("ddMMyyyyHH");
	    ...
	    public static final int BC_JORDON_MOBILY_OPERATOR_ID=125;
	    public static final int MOBIPAY_CELLC_OPERATOR_ID=126;
	    public static final int MOBIPAY_VODACOM_OPERATOR_ID=127;
