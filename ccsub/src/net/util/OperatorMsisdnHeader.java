...
public enum OperatorMsisdnHeader {
	...
	QATAR_OPERATOR_ID(MConstants.QATAR_OPERATOR_ID,"",false),
	VEOO_HONDURAS_TIGO_OPERATOR_ID(MConstants.VEOO_HONDURAS_TIGO_OPERATOR_ID,"msisdn",false),
	VEOO_NICARAGUA_CLARO_OPERATOR_ID(MConstants.VEOO_NICARAGUA_CLARO_OPERATOR_ID,"msisdn",false),
	VEOO_NICARAGUA_MOVISTAR_OPERATOR_ID(MConstants.VEOO_NICARAGUA_MOVISTAR_OPERATOR_ID,"msisdn",false),
	OREDOO_KUWAIT_OPERATOR_ID(MConstants.OREDOO_KUWAIT_OPERATOR_ID,"msisdn",true);
