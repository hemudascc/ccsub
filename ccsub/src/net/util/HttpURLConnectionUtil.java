...
//			}
		 ...
		 public HTTPResponse sendHttpsPost(String url,String data,Map<String,String> headerMap) {
				...
				try {
					...
					logger.info("Sending sendHttpsPost request to URL : " + url
							+ ", Response Code : " + responseCode + ", response: "
							+ response.toString());

				} catch (Exception e) {
					response.append(e.toString());
					logger.error("Sending sendHttpsPost request to URL : " + url
							+ ", Response Code : " + responseCode + ", response: "
							+ response.toString() + ", Excption: " + e);
				} finally {
					...
					try {
						...
						response.append(e.toString());
						// TODO Auto-generated catch block
						logger.error("sendHttpsPost Error in closing http connection for url:" + url
								+ " " , e);
					}
				}
		 ...
		 public HTTPResponse sendHttpsGet(String url,String data,Map<String,String> headerMap) {
				...
				try {
					...
					logger.info("Sending sendHttpsGet request to URL : " + url
							+ ", Response Code : " + responseCode + ", response: "
							+ response.toString());

				} catch (Exception e) {
					response.append(e.toString());
					logger.error("Sending sendHttpsGet request to URL : " + url
							+ ", Response Code : " + responseCode + ", response: "
							+ response.toString() + ", Excption: " + e);
				} finally {
					...
					try {
						...
						response.append(e.toString());
						// TODO Auto-generated catch block
						logger.error("sendHttpsGet Error in closing http connection for url:" + url
								+ " " , e);
					}
				}
		 ...
		 public static void main(String arg[]){
			 ...
			 map.put("account_id", "2a74245f27da4377b30e1d7954026cd8");
			 map.put("api_key", "08a3958640f64a7db4e1a12f4bcb367");
			 map.put("source", "65065");
			 map.put("service_id", "6204");
			 map.put("reference", "1596716925096c82554931c253");
			 map.put("return", "http://192.241.253.234/ccsub/cnt/mobic/callback/1596716925096c82554931c253");
			 map.put("notification", "http://192.241.253.234/ccsub/cnt/mobic/noti");
			 //map.put(key, value);
			 String url="https://gateway.mobivate.com/api/dcb/init";
			 String data= "account_id=2a74245f27da4377b30e1d7954026cd8"
			 		+ "&api_key=08a3958640f64a7db4e1a12f4bcb367b&source=65065&service_id=6204"
			 		+ "&reference=1596716925096c82554931c253&return=http%3A%2F%2F192.241.253.234%2Fccsub%2Fcnt%2Fmobic%2Fcallback%2F1596716925096c82554931c253&notification=http%3A%2F%2F192.241.253.234%2Fccsub%2Fcnt%2Fmobic%2Fnoti";
			 Map<String,String> header=new HashMap<String,String>();
			// HTTPResponse httpResponse= http.sendHttpsPost(url, data, null);
			 header.put("User-Agent", "");
			HTTPResponse httpResponse= http.sendHttpsPost("https://gateway.mobivate.com/api/dcb/init",data,header);
