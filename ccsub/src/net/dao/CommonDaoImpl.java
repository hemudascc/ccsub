...
import net.mycomp.du.DUCGCallback;
...
//			}
	...
	public DUCGCallback findDUCGCallbackByTPCGId(String tpcgId) {
		TypedQuery<DUCGCallback>
		query = entityManager.createNamedQuery("DUCGCallback.findDUCGCallbackByTPCGId",DUCGCallback.class);
		query.setParameter("tpcgId", tpcgId);
		return query.getSingleResult();
	}
...
Map<String, Object> parameters = new HashMap<String, Object>();
		...
		queryStr+=" if(vwlive.network_name is null,'Other',vwlive.network_name) as networkName,"
			     ...
			     + " from vw_inapp_live_report_monthly vwlive left join vw_service_campaign_detail vwscd "
			     + " on vwlive.adnetworkid =vwscd.ad_network_id and vwscd.op_id=vwlive.operator_id "
			     + " and vwlive.service_id =vwscd.service_id "
			   //  +" left join tb_operators op on vwlive.operator_id=op.operator_id "
			     + " where  1=1 ";
