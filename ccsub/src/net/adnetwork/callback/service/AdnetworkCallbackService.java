...
//			Integer opId,Double amount) {
		...
		try {
			...
			logger.info("sendAdnetworkCallBack::"+liveReport.getTokenId()+", adnetworks:: " + adnetworks);
			...
			logger.info("sendAdnetworkCallBack::"+liveReport.getTokenId()+",adnetworkOperatorConfig " + adnetworkOperatorConfig);
				
			boolean isSendToAdnetwork = false;

			if (liveReport.getConversionCount()<=0) {
				//adnetworkToken.setDuplicateConversion(true);
				logger.debug("sendAdnetworkCallBack::"+liveReport.getTokenId()+", conversion count "+liveReport.getConversionCount()+" not send conversion");
		...
		if (adnetworkToken != null && adnetworkToken.getConversionReceived() != null
				...
				adnetworkToken.setDuplicateConversion(true);
				logger.debug("sendAdnetworkCallBack::"+liveReport.getTokenId()+", adnetworkToken != null && adnetworkToken.getConversionReceived() != null:: " );
				return adnetworkToken;
			}
			...
			if (liveReport.getAction() != null && liveReport.getAction().equalsIgnoreCase(MConstants.ACT)) {
				logger.debug("sendAdnetworkCallBack::"+liveReport.getTokenId()+",isSendToAdnetwork:act " + isSendToAdnetwork);
...
//				}			
			...
			if (isSendToAdnetwork && adnetworkToken != null && adnetworkToken.getToken() != null
				...
				logger.debug("sendAdnetworkCallBack:: "+liveReport.getTokenId()+", url : " + adnetworkToken.getTokenId()+",opconfig id"+adnetworkOperatorConfig.getAdnetworkOperatorConfigId());  
				String urlTemplate = adnetworks.getCallbackUrlTemplate();
				logger.info("sendAdnetworkCallBack:: "+liveReport.getTokenId()+", urlTemplate 1 : " + urlTemplate);
				...
				logger.info("sendAdnetworkCallBack:: "+liveReport.getTokenId()+", urlTemplate 2 : " + urlTemplate);
				logger.debug("sendAdnetworkCallBack::"+liveReport.getTokenId()+",  url : " + adnetworkToken.getTokenId()+",opconfig id"+adnetworkOperatorConfig.getAdnetworkOperatorConfigId()+"::urlTemplate"+urlTemplate);
				...
				logger.debug("sendAdnetworkCallBack:: "+liveReport.getTokenId()+", url : " + adnetworkToken.getTokenId()+",opconfig id"+adnetworkOperatorConfig.getAdnetworkOperatorConfigId()+"::urlTemplate"+url);
				logger.info("sendAdnetworkCallBack::"+liveReport.getTokenId()+", url : " + url);
				...
				logger.debug("sendAdnetworkCallBack:: "+liveReport.getTokenId()+", is send 0 " + adnetworkToken.getTokenId()+",opconfig id"+adnetworkOperatorConfig.getAdnetworkOperatorConfigId()+"::url:"+url);
			}

		} catch (Exception ex) {
			logger.error("sendAdnetworkCallBack::"+liveReport.getTokenId()+", Exception : " + ex+"adnetworkToken::"+adnetworkToken);
		} finally {
